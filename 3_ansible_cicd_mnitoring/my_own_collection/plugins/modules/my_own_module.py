...
description: Module create file with some content.

options:
    path:
        description: This is the path to created file.
        required: true
        type: str
    content:
        description:
            - Content to add in creating file.
        required: false
        type: str
...
def run_module():
    ...
    #else:
    #    with open(module.params['path'], 'a') as file:
    #         file.write(module.params['content'] + '\n')
